  ...
  return (
    <MarketingShell>
      <main className="mx-auto max-w-[1100px] px-6 py-20 lg:px-10 lg:py-32">
        <div className="mb-6 text-[12px] uppercase tracking-[0.12em] text-[#D4A373]">About Talkivo</div>
        ...
        <p className="mt-8 max-w-[720px] text-[18px] leading-[1.6] text-[#9A948A]">
        ...
        <section className="mt-20 grid gap-16 lg:grid-cols-2">
          <div>
            <h2 className="font-serif-display text-[32px] leading-[1.15] text-[#F5F2EC]">Why we built it</h2>
            <p className="mt-4 text-[15px] leading-[1.7] text-[#9A948A]">
          ...
          <div>
            <h2 className="font-serif-display text-[32px] leading-[1.15] text-[#F5F2EC]">What we believe</h2>
            <ul className="mt-4 space-y-4 text-[15px] leading-[1.7] text-[#9A948A]">
              <li><span className="text-[#F5F2EC]">Fluency is built in minutes a day, not hours a week.</span> Daily beats intense every time.</li>
              <li><span className="text-[#F5F2EC]">Every correction should come with a reason.</span> A red line teaches nothing.</li>
              <li><span className="text-[#F5F2EC]">Patience beats pressure.</span> Good tutors wait for the full thought.</li>
              <li><span className="text-[#F5F2EC]">Clarity, not imitation.</span> The goal is to be understood \u2014 not to sound like someone else.</li>
            </ul>
          </div>
        </section>

        <section className="mt-24 rounded-2xl border border-[#2A2A2E] bg-[#17171A] p-10 lg:p-14">
          <h2 className="font-serif-display text-[32px] leading-[1.15] text-[#F5F2EC]">Built in India, for the world</h2>
          <p className="mt-4 max-w-[720px] text-[15px] leading-[1.7] text-[#9A948A]">
        ...
        <section className="mt-24">
          <h2 className="font-serif-display text-[32px] leading-[1.15] text-[#F5F2EC]">Start where you are</h2>
          <p className="mt-4 max-w-[640px] text-[15px] leading-[1.7] text-[#9A948A]">
